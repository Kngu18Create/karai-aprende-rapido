  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold text-slate-800 font-poppins">Gestión de Archivos</h1>
      ...
      <Tabs defaultValue="upload" className="w-full">
        ...
        <TabsContent value="upload" className="space-y-6">
          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle className="text-slate-800">Subir Nuevo Material</CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-6">
              <div 
                className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors ${
                  dragActive ? "border-blue-500 bg-blue-50" : "border-border bg-muted/20"
                }`}
              ...
              {uploading && (
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-slate-700">Subiendo archivo...</span>
              ...
              <div className="space-y-4">
                <Label htmlFor="folder" className="text-slate-700">Carpeta de Destino</Label>
                <Input 
                  id="folder" 
        ...
        <TabsContent value="manage" className="space-y-6">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-semibold text-slate-800">Mis Archivos</h2>
